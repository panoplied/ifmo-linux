...
#     записать данные, но удалить любой файл сможет только пользователя, который его создал или
#     пользователь u1

# 16. Скопирует в каталог test15 исполняемый файл редактора nano и сделает так, чтобы любой
#     пользователь смог изменять с его помощью файлы, созданные в пункет 13
